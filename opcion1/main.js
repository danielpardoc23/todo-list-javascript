...
function mostrarLista(){
    ...
    for(let i = 0; i < list.length; i++){
        cadena += "<section><li><h3>" + list[i].name + "</h3></li>"
        + "<ul><li>" + list[i].description + "</li>"
        + "<li>Prioridad: " + list[i].priority + "</li>"+
        "<li>Estado: " + list[i].state + "</li></ul></section>";
    }

    document.getElementById('todoList').innerHTML = cadena;
}
            ...
            cadena += "<div class='row' id='tarea'>"
                        + "<div class='col-lg-6'>"
                            ...
                            + "</div>"
                                ...
                                + "</select><br>"
                                + "<button onclick='updateState(`" + list[i].name + "`)' class='btn btn-primary'>Actualizar estado</button><br>"
                                + "<button class='btn btn-danger' onclick='deleteTask(`" + list[i].name + "`)'>Eliminar " + list[i].name + "</button>"
                            + "</div>"
                    + "</div>";
        }
    }
...
/*
if(!hola){ Entra si es null, 0 o undefined

}

if(!!hola) Entra si no es null, 0 o undefined
*/